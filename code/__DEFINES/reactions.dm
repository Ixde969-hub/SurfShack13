...
// SURFSHACK EDIT: classic fusion constants must not overwrite the HFR constants.
#define CLASSIC_FUSION_TEMPERATURE_THRESHOLD 9000
#define CLASSIC_FUSION_MOLE_THRESHOLD 250
#define CLASSIC_FUSION_TRITIUM_MOLES_USED 1
#define CLASSIC_FUSION_BINDING_ENERGY 20000000
#define CLASSIC_FUSION_ENDOTHERMALITY 2
#define CLASSIC_FUSION_MAXIMUM_TEMPERATURE 1e8
#define CLASSIC_FUSION_MID_THRESHOLD 5
#define CLASSIC_FUSION_HIGH_THRESHOLD 20
#define CLASSIC_FUSION_SUPER_THRESHOLD 50
